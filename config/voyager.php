...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'categories', 'menus', 'pages', 'permission_groups', 'permissions', 'posts', 'roles', 'translations', 'users'],
        ],
    ],
